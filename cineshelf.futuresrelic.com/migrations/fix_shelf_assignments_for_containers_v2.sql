...
-- Version 2: Fixed to handle existing columns correctly
-- ============================================
...
-- Step 2: Copy existing data (only columns that exist)
-- Note: If notes column doesn't exist in old table, it will be NULL in new table
